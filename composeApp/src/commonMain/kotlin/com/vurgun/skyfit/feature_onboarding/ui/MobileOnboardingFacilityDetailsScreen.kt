...
fun MobileOnboardingFacilityDetailsScreen(
    ...
    val name = viewModel.state.collectAsState().value.facilityName
    val address = viewModel.state.collectAsState().value.facilityAddress
    val biography = viewModel.state.collectAsState().value.facilityBiography
