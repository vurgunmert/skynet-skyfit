...
import com.vurgun.skyfit.presentation.shared.features.onboarding.OnboardingDateOfBirthSelectorComponent
...
@Composable
fun MobileOnboardingBirthYearSelectionScreen(navigator: Navigator) {
    SkyFitScaffold {
        Column(
            ...
            OnboardingDateOfBirthSelectorComponent()
