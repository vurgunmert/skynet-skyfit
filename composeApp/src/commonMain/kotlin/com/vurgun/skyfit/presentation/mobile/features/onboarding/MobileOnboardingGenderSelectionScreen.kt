...
import com.vurgun.skyfit.presentation.shared.features.onboarding.OnboardingGenderSelectorComponent
...
@Composable
fun MobileOnboardingGenderSelectionScreen(navigator: Navigator) {
    SkyFitScaffold {
        Column(
