    ...
    SkyFitScaffold(
        ...
        Column(
            ...
            MobileSettingsMenuItemComponent(
                ...
                onClick = { navigator.jumpAndStay(SkyFitNavigationRoute.TrainerSettingsAccount) }
            )

            MobileSettingsMenuItemComponent(
                text = "Ödeme Geçmişi",
                iconRes = Res.drawable.ic_credit_card,
                onClick = { navigator.jumpAndStay(SkyFitNavigationRoute.TrainerSettingsPaymentHistory) }
            )
            ...
            MobileSettingsMenuItemComponent(
                ...
                onClick = { navigator.jumpAndStay(SkyFitNavigationRoute.TrainerSettingsNotifications) }
            )
            ...
            MobileSettingsMenuItemComponent(
                ...
                onClick = { navigator.jumpAndStay(SkyFitNavigationRoute.TrainerSettingsHelp) }
            )
        }
    }
}