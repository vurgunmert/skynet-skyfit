...
fun MobileUserSettingsNotificationsScreen(navigator: Navigator) {
    ...
    Scaffold(
        ...
        topBar = {
            MobileUserSettingsNotificationsScreenToolbarComponent()
        }
    ) {
        Column(
...
@Composable
private fun MobileUserSettingsNotificationsScreenToolbarComponent() {
    TodoBox("MobileUserSettingsNotificationsScreenToolbarComponent", Modifier.size(430.dp, 40.dp))
}

@Composable
private fun MobileUserSettingsNotificationsScreenOptionsComponent() {
    TodoBox("MobileUserSettingsNotificationsScreenOptionsComponent", Modifier.size(382.dp, 690.dp))
}