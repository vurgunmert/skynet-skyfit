...
import com.vurgun.skyfit.presentation.shared.features.onboarding.OnboardingHeightSelectorComponent
...
@Composable
fun MobileOnboardingHeightSelectionScreen(navigator: Navigator) {
    SkyFitScaffold {
        Column(
            ...
            OnboardingHeightSelectorComponent()
