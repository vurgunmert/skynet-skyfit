...
@Composable
fun MobileFacilityClassesVisitedScreen(navigator: Navigator) {

    Button({
        navigator.jumpAndTakeover(SkyFitNavigationRoute.FacilityClassesVisited, SkyFitNavigationRoute.Dashboard)
