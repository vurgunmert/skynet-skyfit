...
interface AuthRepository {
    ...
    suspend fun login(phoneNumber: String, otp: String?): NetworkResponseWrapper<SignInResponse>
    suspend fun resendOtpCode(phoneNumber: String): NetworkResponseWrapper<Boolean>
}
