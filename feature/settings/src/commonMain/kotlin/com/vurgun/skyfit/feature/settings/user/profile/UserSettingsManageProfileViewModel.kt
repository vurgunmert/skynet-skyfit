...
data class UserSettingsManageProfileUiState(
    val userName: String = "",
...
class UserSettingsManageProfileViewModel(
    ...
    private val _accountState = MutableStateFlow(UserSettingsManageProfileUiState())
    val accountState: StateFlow<UserSettingsManageProfileUiState> = _accountState

    private var initialState: UserSettingsManageProfileUiState? = null

    fun loadData() {
        val initial = UserSettingsManageProfileUiState(
    ...
    private fun updateState(update: UserSettingsManageProfileUiState.() -> UserSettingsManageProfileUiState) {
