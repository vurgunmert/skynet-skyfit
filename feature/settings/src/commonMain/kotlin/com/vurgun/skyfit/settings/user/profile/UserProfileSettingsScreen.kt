package com.vurgun.skyfit.settings.user.profile
...
@Composable
private fun UserProfileSettingsContent(
    ...
    Scaffold(
        ...
        Column(
            ...
            TitledMediumRegularText(
                ...
                title = stringResource(Res.string.settings_edit_profile_height_label, formState.heightUnit.shortLabel),
            ...
            TitledMediumRegularText(
                ...
                title = stringResource(Res.string.body_type_label),
