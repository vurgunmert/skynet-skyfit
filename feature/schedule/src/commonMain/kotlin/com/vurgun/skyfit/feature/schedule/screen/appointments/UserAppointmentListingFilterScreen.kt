...
class UserAppointmentListingFilterScreen(
    ...
    override fun Content() {
        ...
        val allLessons = (state as? UserAppointmentListingUiState.Content)?.appointments.orEmpty()
        ...
        val appliedFilter = (state as? UserAppointmentListingUiState.Content)?.currentFilter
        ...
        SkyFitMobileScaffold(
            topBar = {
                UserAppointmentListingFilterHeader(
            ...
            Column(
                ...
                PrimaryLargeButton(
                    ...
                    modifier = Modifier.fillMaxWidth(),
                    onClick = {
                        val selectedFilter = UserAppointmentListingFilter(
...
@Composable
private fun UserAppointmentListingFilterHeader(
