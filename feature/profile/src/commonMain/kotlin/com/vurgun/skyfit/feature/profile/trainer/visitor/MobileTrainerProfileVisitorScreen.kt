...
import skyfit.ui.core.generated.resources.follow_action
...
import skyfit.ui.core.generated.resources.posts_label
import skyfit.ui.core.generated.resources.private_lessons_label
import skyfit.ui.core.generated.resources.show_all_action
import skyfit.ui.core.generated.resources.specialities_label
import skyfit.ui.core.generated.resources.unfollow_action

@Composable
fun MobileTrainerProfileVisitorScreen(
    trainerId: Int,
    goToBack: () -> Unit,
    goToChat: () -> Unit,
    goToSchedule: () -> Unit,
    viewModel: TrainerProfileVisitorViewModel = koinViewModel()
) {
    ...
    when (uiState) {
        is TrainerProfileVisitorUiState.Loading -> FullScreenLoader()
