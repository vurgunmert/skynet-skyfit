...
import com.vurgun.skyfit.core.data.mapper.CalendarEventMapper.toDomainCalendarEvents
import com.vurgun.skyfit.core.data.mapper.CalendarEventMapper.toDomainWorkoutEvents
import com.vurgun.skyfit.core.data.model.AddCalendarEventRequest
import com.vurgun.skyfit.core.data.model.GetCalendarEventsRequest
...
class UserCalendarRepositoryImpl(
    ...
    override suspend fun getCalendarEvents(
        ...
        val token = tokenManager.getTokenOrThrow()
        apiService.getCalendarEvents(calendarRequest, token).mapOrThrow { it.toDomainCalendarEvents() }
    }
